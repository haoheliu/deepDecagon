...
class DecagonOptimizer(object):
    ...
    def batch_predict(self, row_inputs, col_inputs):
        ...
        #tf.gather: select the object with indexes in the second operand
    ...
    #This function was only used to build the compute graph
    def predict(self):
        concatenated = tf.concat(self.embeddings, 0)
    ...
    #This function was only used when constructing compute graph
    def _build(self):
